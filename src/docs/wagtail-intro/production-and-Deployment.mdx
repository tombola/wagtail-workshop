...
These extra requirements come together in a pip package called [django-toolbelt](https://pypi.org/project/django-toolbelt/). We'll install this, and then use the `pip freeze` command to update our requirements.txt file.
