...
This section of the course is about building and deploying our wagtail site. We'll build our site locally, push it to github, and using heroku and AWS we will configure a production envoronment for your work to be live to the world.
